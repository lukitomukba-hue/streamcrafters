...
import { Crown, Sparkles, Film, Music, Bot, ShieldCheck, ArrowRight, UserCheck, Star, ChevronRight } from "lucide-react";
      ...
      <header className="max-w-6xl mx-auto px-4 py-5 flex items-center justify-between border-b border-amber-500/20 relative z-20 backdrop-blur-md">
        <div className="flex items-center gap-3">
          <div className="relative group cursor-pointer">
            ...
            <div style={{ width: '48px', height: '48px' }} className="relative bg-black rounded-2xl border border-amber-500/50 p-1 flex items-center justify-center shadow-2xl overflow-hidden">
