...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(isRegister ? "VIP რეგისტრაცია წარმატებით დასრულდა!" : "VIP ავტორიზაცია წარმატებულია!");
    onClose();
  };
      ...
      <div className="bg-[#0a0a0c] border border-amber-500/40 rounded-3xl w-full max-w-md p-6 md:p-8 shadow-2xl shadow-amber-500/10 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="relative mb-3 group">
            ...
            <div style={{ width: '64px', height: '64px' }} className="relative bg-black rounded-2xl border border-amber-500/50 p-1.5 flex items-center justify-center shadow-2xl overflow-hidden">
